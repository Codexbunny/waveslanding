      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: 'Professional Brokerage Account Advisory',
            provider: {
              '@type': 'Organization',
              name: 'Waves Logix Ltd.',
            },
            description: 'Professional advisory and analytical support for high-net-worth clients managing brokerage accounts in Forex, gold, and oil markets.',
